...
<div class="container">
	<div class="row">
		<p class="copyright col-12 col-md-8 alert">Copyright <?php echo date('Y'); ?> | Mahahual Q.Roo México</p>
		<div class="col-12 col-md-4 align-right">
			<ul class="footer-social row">
				<li class="col-2 et-social-icon et-social-facebook mx-auto">
					<a href="https://www.facebook.com/YayaBeach/" class="icon" target="_blank">
					</a>
				</li>
				<li class="col-2 et-social-icon et-social-instagram mx-auto">
